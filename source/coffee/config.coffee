          ...
          firebaseAuthorized: ['$rootScope','Firebase', '$window', ($rootScope, Firebase, $window) ->
            ...
            delphirePromise.then () ->
              ...
              if location.href.indexOf('localhost') isnt -1
                ...
                # emmons
                return fbToken = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..K-V7Dr_yGoLRgb5kYB1IfoXMZPrXruqG8aQBrnGwVHJ5khS5mwuv5Iq7YnUfM5a-VHjAmvs82-v1McQLk_uENisfZQxQGWQYMNxQPxwL7rF_ovL-ZzsM8rppAKr1L3OJrktFjxwAHGICKOHbkI8oOTPKKH2V5eDWH5yZu4Qg6-EIG43kwMwxYSvoLU_z-FCXJMxuM2NVlzEQTimmuUEg3ZNtRLnmKOOBR3AfpNoQRRSdx5VMwrdC2mif7Ue1Cc5qwehKTKK2Cz2la1a4aVDUow53P_QFJ9cFVMMfK8rJ70oh65UZ_bgrkhyWF1in18iUkf2N_VNOSWAFoomYNulVRA"
