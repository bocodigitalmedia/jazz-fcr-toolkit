module.exports = (angular, defaults) ->
  ...
  angular.module defaults.app.name
    .component 'integrity', {
      replace: true
      transclude: true
      templateUrl: 'components/integrity.html'
      controllerAs: 'ctrl'
      bindings:
          ...
          chart:
            ...
            events:
              addSeries: (event) ->
                ...
                span = '''
                  <span id="integrityChartCenter" style="position:absolute; text-align:center;">
                ...
                $('#integrity-percentage').html span
                span = $('#integrityChartCenter')
